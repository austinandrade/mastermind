...
class PlayerGuessMatcherTest < Minitest::Test
  ...
  def test_check_number_of_correct_colors
    ...
    mastermind = Mastermind.new(@winning_code)
    player_guess_matcher = PlayerGuessMatcher.new(@winning_code, @player_guess)

    assert_equal 3, player_guess_matcher.check_number_of_correct_colors(@player_guess)
  end
  ...
  def test_check_number_of_correct_color_and_position
    ...
    assert_equal 1, player_guess_matcher.check_number_of_correct_color_and_position(@player_guess)
  end
end
